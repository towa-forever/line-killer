...
const UserSchema = new mongoose.Schema({
  ...
  real_name_submitted_at: { type: Date, default: null },
...
const SystemNoticeSchema = new mongoose.Schema({
  id:          { type: String, required: true, unique: true },
  type:        { type: String, default: 'general' }, // 'general' | 'survey' | 'urgent'
  title:       { type: String, required: true },
  content:     { type: String, default: '' },
  action_type: { type: String, default: null }, // 'real_name' | 'url' | null
  action_url:  { type: String, default: null },
  dismissed_by:[String], // 閉じたユーザーIDリスト
  created_at:  { type: Date, default: Date.now },
  expires_at:  { type: Date, default: null },
});
...
module.exports = {
  SystemNotice: mongoose.model('SystemNotice', SystemNoticeSchema),
